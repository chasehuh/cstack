...
| `aside-browser-verify.mdc` | Browser verification: `ego-browser` TaskSpace (preferred) or `aside repl`; own tab; dev/prod under sumelabs; dest Auto; local first, then dest |
